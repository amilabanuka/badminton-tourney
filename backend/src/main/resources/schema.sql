...
-- Create tournament_apl_settings table
...
-- Create apl_game_day_group table
...
-- Create apl_game_day_group_player table
...
-- Create apl_game_day_group_match table
...
-- Create apl_rank_score_history table
