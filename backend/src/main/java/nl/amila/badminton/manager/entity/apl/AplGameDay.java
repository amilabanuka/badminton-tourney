...
@Entity
@Table(name = "apl_game_day")
@Getter
@Setter
@NoArgsConstructor
public class AplGameDay {
    ...
    private AplGameDayStatus status = AplGameDayStatus.PENDING;
    ...
    private Set<AplGameDayGroup> groups = new LinkedHashSet<>();

    public AplGameDay(Tournament tournament, LocalDate gameDate) {
